...
declare namespace chrome {
    ...
    class Options {
         ...
         *
         * The binary path be absolute or relative to the chromedriver backend
    ...
    class ServiceBuilder {
        /**
         * @param {string=} opt_exe Path to the backend executable to use. If omitted,
        ...
        /**
         * Defines the environment to start the backend under. This settings will be
         * inherited by every browser session started by the backend.
...
declare namespace firefox {
    ...
    class Profile {
         ...
         *     {@link #encode() encoded profile} since the backend will always install
...
declare namespace executors {
     ...
     * @param url The backend's URL, or a promise that will resolve to that URL.
...
declare namespace webdriver {
    ...
    class Builder {
        ...
        /**
         * @return {string} The URL of the WebDriver backend this instance is configured
         *     to use.
         */
        getServerUrl(): string;
        ...
        /**
         * Sets the URL of a remote WebDriver backend to use. Once a remote URL has been
         * specified, the builder direct all new clients to that backend. If this method
         ...
         *
         * @param {string} url The URL of a remote backend to use.
         * @return {!Builder} A self reference.
         */
    ...
    class WebDriver {
         ...
         * promise for when a backend is ready for requests. You can block a `WebDriver`
         ...
         *     DOM element to be located by the backend.
    ...
    class WebElement implements Serializable<IWebElementId> {
         ...
         *           webdriver.WebElement.Id)} id The backend-assigned opaque ID for the
         ...
         * running against a remote Selenium backend, a {@link webdriver.FileDetector}
